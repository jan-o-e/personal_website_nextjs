import React, { createContext, useContext, Fragment, forwardRef } from 'react';
import cs from 'clsx';
...
var Img = function Img(_ref) {
  ...
  var image = React.createElement(Image, _extends({}, p, {
    src: src + "&name=small",
    quality: 80,
    alt: "Tweet image " + src,
    fill: true,
...
var Tweet = forwardRef(function (_ref, ref) {
  ...
  return React.createElement("article", {
    ...
    components: components,
    node: ast[0]
  }), caption && React.createElement("p", {
    className: 'static-tweet-caption'
  }, caption));
});

var TweetClient = forwardRef(function (_ref, ref) {
  var id = _ref.id,
    ast = _ref.ast,
    caption = _ref.caption,
    className = _ref.className;
...
export { Tweet, TweetClient, TwitterContextConsumer, TwitterContextProvider, useTwitterContext };
