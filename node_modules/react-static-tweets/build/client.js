...
var _excluded$1 = ["width", "height", "src", "dataUrl"];
var Img = function Img(_ref) {
  ...
  var image = React__default["default"].createElement(Image__default["default"], _extends({}, p, {
    src: src + "&name=small",
    quality: 80,
    alt: "Tweet image " + src,
    fill: true,
  ...
  }, dataUrl ? React__default["default"].createElement("a", {
    href: dataUrl,
    className: 'avatar',
    target: '_blank',
    rel: 'noopener noreferrer'
  }, image) : React__default["default"].createElement("div", {
    className: 'avatar'
  }, image)));
};
...
var Tweet = React.forwardRef(function (_ref, ref) {
  ...
  if (!(ast != null && ast.length)) {
    return null;
  }
  return React__default["default"].createElement("article", {
    ref: ref,
    className: cs__default["default"]('static-tweet', className)
  }, React__default["default"].createElement(Node, {
    components: components,
    node: ast[0]
  }), caption && React__default["default"].createElement("p", {
    className: 'static-tweet-caption'
  }, caption));
});

var TweetClient = React.forwardRef(function (_ref, ref) {
  var id = _ref.id,
    ast = _ref.ast,
    caption = _ref.caption,
    className = _ref.className;
  var twitter = useTwitterContext();
  var tweetAst = ast || twitter.tweetAstMap[id];
  if (!tweetAst) {
    return null;
  }
  return React__default["default"].createElement("article", {
